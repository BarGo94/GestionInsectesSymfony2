 ...
 */
class BonSortie extends \FamilleBundle\Entity\BonSortie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'id', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'ref', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'des', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'unite', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'qte', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'prix', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'montant', '' . "\0" . 'FamilleBundle\\Entity\\BonSortie' . "\0" . 'date'];
        }
