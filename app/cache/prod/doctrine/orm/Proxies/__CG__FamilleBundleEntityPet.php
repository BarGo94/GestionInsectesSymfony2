 ...
 */
class Pet extends \FamilleBundle\Entity\Pet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FamilleBundle\\Entity\\Pet' . "\0" . 'id', '' . "\0" . 'FamilleBundle\\Entity\\Pet' . "\0" . 'ref', '' . "\0" . 'FamilleBundle\\Entity\\Pet' . "\0" . 'des', '' . "\0" . 'FamilleBundle\\Entity\\Pet' . "\0" . 'unite', '' . "\0" . 'FamilleBundle\\Entity\\Pet' . "\0" . 'qte', '' . "\0" . 'FamilleBundle\\Entity\\Pet' . "\0" . 'prix'];
        }
