 ...
 */
class Pvcc extends \FamilleBundle\Entity\Pvcc implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FamilleBundle\\Entity\\Pvcc' . "\0" . 'id', '' . "\0" . 'FamilleBundle\\Entity\\Pvcc' . "\0" . 'ref', '' . "\0" . 'FamilleBundle\\Entity\\Pvcc' . "\0" . 'des', '' . "\0" . 'FamilleBundle\\Entity\\Pvcc' . "\0" . 'unite', '' . "\0" . 'FamilleBundle\\Entity\\Pvcc' . "\0" . 'qte', '' . "\0" . 'FamilleBundle\\Entity\\Pvcc' . "\0" . 'prix'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pvcc $proxy) {
