 ...
 */
class Iso extends \FamilleBundle\Entity\Iso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FamilleBundle\\Entity\\Iso' . "\0" . 'id', '' . "\0" . 'FamilleBundle\\Entity\\Iso' . "\0" . 'ref', '' . "\0" . 'FamilleBundle\\Entity\\Iso' . "\0" . 'des', '' . "\0" . 'FamilleBundle\\Entity\\Iso' . "\0" . 'unite', '' . "\0" . 'FamilleBundle\\Entity\\Iso' . "\0" . 'qte', '' . "\0" . 'FamilleBundle\\Entity\\Iso' . "\0" . 'prix'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Iso $proxy) {
