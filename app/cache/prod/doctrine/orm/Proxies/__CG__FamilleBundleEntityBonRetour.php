 ...
 */
class BonRetour extends \FamilleBundle\Entity\BonRetour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FamilleBundle\\Entity\\BonRetour' . "\0" . 'id', '' . "\0" . 'FamilleBundle\\Entity\\BonRetour' . "\0" . 'des', '' . "\0" . 'FamilleBundle\\Entity\\BonRetour' . "\0" . 'qte', '' . "\0" . 'FamilleBundle\\Entity\\BonRetour' . "\0" . 'etat', '' . "\0" . 'FamilleBundle\\Entity\\BonRetour' . "\0" . 'obs', '' . "\0" . 'FamilleBundle\\Entity\\BonRetour' . "\0" . 'date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BonRetour $proxy) {
