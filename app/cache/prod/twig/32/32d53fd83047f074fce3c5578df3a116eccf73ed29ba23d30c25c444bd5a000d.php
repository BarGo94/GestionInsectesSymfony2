...
/* FamilleBundle:Famille:affichage_spl.html.twig */
class __TwigTemplate_973ee18dca2979ac91a8ce7b4e94ef91334fae5a5e28dad03c42cd61117de34f extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 3
        $this->parent = $this->loadTemplate("MyAppUserBundle::gridLayout.html.twig", "FamilleBundle:Famille:affichage_spl.html.twig", 3);
        $this->blocks = array(
    ...
    <div class=\"container\">
            ...
            <div class=\"col-md-10\">
                <div class=\"panel panel-primary\">
                    <div class=\"panel-heading\">
                        <h3 class=\"panel-title\">Tableau de Condair plus , Liste de stock Famille: SPLIT SYSTEME</h3>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["o"]) {
            ...
            echo " </td>
                                    <td><a href=\"";
            // line 46
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("supprimer_spl", array("id" => $this->getAttribute($context["o"], "id", array()))), "html", null, true);
            echo "\">Supprimer</a></td>
                                    <td><a href=\"";
            // line 47
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("modifier_spl", array("id" => $this->getAttribute($context["o"], "id", array()))), "html", null, true);
...
";
    ...
    {
        return "FamilleBundle:Famille:affichage_spl.html.twig";
    }
...
/*                                     <td><a href="{{ path('supprimer_spl', {'id':o.id}) }}">Supprimer</a></td>*/
/*                                     <td><a href="{{ path('modifier_spl', {'id':o.id}) }}">Modification</a></td>*/
/*                                 </tr> */
/*                             {% endfor %}*/
/* */
/*                         </tbody>*/
