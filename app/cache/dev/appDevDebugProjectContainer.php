...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gestion', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MyAppUserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\FamilleBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MyAppUserBundle\\Entity');
        $c->addDriver($b, 'FamilleBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MyAppUserBundle' => 'MyAppUserBundle\\Entity', 'FamilleBundle' => 'FamilleBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3b620cbdf7ba66b53f85a4df9d5393d37d9ff44752dd40795115349d832c55db');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MyAppUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('poutchinho@gmail.com' => 'Alaa'), 'resetting' => array('poutchinho@gmail.com' => 'Alaa'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MyAppUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MyAppUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MyAppUserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MyAppUserBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \MyAppUserBundle\Redirection\AfterLoginRedirection A MyAppUserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \MyAppUserBundle\Redirection\AfterLoginRedirection($this->get('router'), $this->get('security.authorization_checker'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DevService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajout');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/list');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/delete');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modif');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/detail');
        ...
        $q->add($i, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $q->add($j, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $q->add($k, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $q->add($l, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $q->add($m, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $q->add($n, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $q->add($o, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        ...
        return $this->services['security.firewall.map.context.dev'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($q, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'dev', $a, $c), 2 => $s, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $r, 'dev', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'dev'), $t, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '59cbe567ad98d0.24953717', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $q, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $r, 'dev', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $r, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('poutchinho@gmail.com');
        $a->setPassword('siamonoi');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyAppUserBundle/Resources/views'), 'MyAppUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\FamilleBundle/Resources/views'), 'Famille');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $this->get('security.user_checker'), 'dev', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59cbe567ad98d0.24953717')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_AGENT' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyAppUserBundle' => 'MyAppUserBundle\\MyAppUserBundle',
                'UserBundle' => 'UserBundle\\UserBundle',
                'FamilleBundle' => 'FamilleBundle\\FamilleBundle',
            ...
            'mailer_user' => 'poutchinho@gmail.com',
            'mailer_password' => 'siamonoi',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'poutchinho@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'siamonoi',
            ...
            'fos_user.model.user.class' => 'MyAppUserBundle\\Entity\\User',
