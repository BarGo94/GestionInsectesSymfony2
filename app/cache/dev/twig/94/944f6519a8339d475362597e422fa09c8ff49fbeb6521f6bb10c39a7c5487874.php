...
/* FamilleBundle:Famille:affichage_accrec.html.twig */
class __TwigTemplate_4b862da602834e59ac7a5ed2c6029ac9d79e7bdf03f0e6ec383e6bf8c6aa58ea extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 3
        $this->parent = $this->loadTemplate("MyAppUserBundle::gridLayout.html.twig", "FamilleBundle:Famille:affichage_accrec.html.twig", 3);
        $this->blocks = array(
    ...
    <div class=\"container\">
            ...
            <div class=\"col-md-10\">
                <div class=\"panel panel-primary\">
                    <div class=\"panel-heading\">
                        <h3 class=\"panel-title\">Tableau de Condair plus , Liste de stock Famille:  ACCESSOIRES RECUPEREES</h3>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["os"]) ? $context["os"] : $this->getContext($context, "os")));
        foreach ($context['_seq'] as $context["_key"] => $context["o"]) {
            ...
            echo " </td>
                                    <td><a href=\"";
            // line 47
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("supprimer_accrec", array("id" => $this->getAttribute($context["o"], "id", array()))), "html", null, true);
            echo "\">Supprimer</a></td>
                                    <td><a href=\"";
            // line 48
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("modifier_accrec", array("id" => $this->getAttribute($context["o"], "id", array()))), "html", null, true);
...
";
    ...
    {
        return "FamilleBundle:Famille:affichage_accrec.html.twig";
    }
    ...
    {
        return array (  132 => 61,  129 => 60,  117 => 51,  108 => 48,  104 => 47,  100 => 46,  96 => 45,  92 => 44,  88 => 43,  84 => 42,  80 => 40,  76 => 39,  41 => 6,  38 => 5,  30 => 4,  11 => 3,);
    }
}
/* {# empty Twig template #}*/
/* */
...
/*                                     <td><a href="{{ path('supprimer_accrec', {'id':o.id}) }}">Supprimer</a></td>*/
/*                                     <td><a href="{{ path('modifier_accrec', {'id':o.id}) }}">Modification</a></td>*/
/*                                 </tr> */
/*                             {% endfor %}*/
/* */
/*                         </tbody>*/
